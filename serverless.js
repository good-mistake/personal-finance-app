...
module.exports = {
  ...
  functions: {
    ...
    budgets: {
      handler: "api/budgets/index.handler",
      events: [
    ...
    transactions: {
      handler: "api/transactions/index.handler",
      events: [
        ...
        {
          http: { path: "api/transactions/{id}", method: "delete", cors: true },
        },
      ],
    },
    pots: {
      handler: "api/pots/index.handler",
      events: [
